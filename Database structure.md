...
| explanation  | TEXT | The meaning of the thesaurus entry |
...
| date_created| DATE | Date when the record was created in the published version of the database |
| date_changed| DATE | Date when the last change to the record was published |
| title   | VARCHAR(255) | The short title of the criterion used throughout the database.  |
...
| date_created| DATE | Date when the record was created in the published version of the database |
| date_changed| DATE | Date when the last change to the record was published |
| full_name         | TEXT | Official full name of the collection |
