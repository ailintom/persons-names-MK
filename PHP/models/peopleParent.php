 ...
 * A model for people
 * This is the model used when a person being a parent of another person is being searched for
 *
 */
...
class peopleParent extends peoplePairs
{
    ...
    protected $query1b = 'SELECT attestations_id, children_temp.parent_id as parent_id, attestations_id AS id, inscriptions.inscriptions_id AS inscriptions_id, gender, title_string, title_string_sort, personal_name, personal_name_sort, object_type, title, title_sort, dating, (dating_sort_start+dating_sort_end) as dating_sort, (region_temp) AS region FROM ( attestations INNER JOIN inscriptions ON attestations.inscriptions_id = inscriptions.inscriptions_id) INNER JOIN children_temp ON attestations.attestations_id = children_temp.child_id';
