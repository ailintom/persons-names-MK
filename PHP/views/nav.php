...
<nav class="nav" id="nav">
    <ul class="nav_list">
        <li class="nav_item <?= in_array($page, ['names', 'name']) ? '-active' : '' ?>">
            <a href="<?= \PNM\Request::makeURL('names') ?>" class="nav_link"><?= Icon::get('name', '') ?> Personal Names</a>
        </li>
        <li class="nav_item <?= in_array($page, ['titles', 'title']) ? '-active' : '' ?>">
            <a href="<?= \PNM\Request::makeURL('titles') ?>" class="nav_link"><?= Icon::get('title', '') ?> Titles</a>
        </li>
        <li class="nav_item <?= in_array($page, ['people', 'person', 'attestation']) ? '-active' : '' ?>">
            <a href="<?= \PNM\Request::makeURL('people') ?>" class="nav_link"><?= Icon::get('people', '') ?> People</a>
        </li>
        <li class="nav_item <?= in_array($page, ['inscriptions', 'inscription']) ? '-active' : '' ?>">
            <a href="<?= \PNM\Request::makeURL('inscriptions') ?>" class="nav_link"><?= Icon::get('object', '') ?> Inscribed Objects</a>
        </li>
        <li class="nav_item <?= in_array($page, ['places', 'place', 'group', 'workshop']) ? '-active' : '' ?>">
            <a href="<?= \PNM\Request::makeURL('places') ?>" class="nav_link"><?= Icon::get('place', '') ?> Places</a>
        </li>
        <li class="nav_item <?= in_array($page, ['collections', 'collection']) ? '-active' : '' ?>">
            <a href="<?= \PNM\Request::makeURL('collections') ?>" class="nav_link"><?= Icon::get('collection', '') ?> Collections</a>
        </li>
    </ul>
